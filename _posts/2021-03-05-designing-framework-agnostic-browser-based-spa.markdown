...
You can check <a href='https://github.com/DGrudzynskyi/todomvc-mobx-react-mvvm/blob/master/app/framework-extensions/create-connect.tsx'>the actual implementation of connectFn</a> in the TodoMVC app.
